...
export const trucksCatalog = [
	{
		...
		price: 1000,
		maxSpeed: 60,
		description: 'Автокран Liebherr 40 тонн обладает небольшим весом и компактными габаритами, что делает его одним из лучших решений для работ, проводимых в условиях города.<br /><br />Крупнотоннажный транспорт на автомобильном ходу широкого применяется в рамках строительных мероприятий, при реконструкции объектов разного назначения, во время монтажа оборудования, с целью перемещения тяжеловесных кранов на гусеничном ходу, а также для проведения разгрузочно- погрузочных работ.< br /> <br /> Основное предназначение модели – проведение строительных работ.Также техника широкого применяется в процессе разработки месторождений в нефтегазовой сфере. Автокран Liebherr LTM 1040 может применяться для разноплановых операций в неблагоприятных температурных условиях.'
	},
	{
		id: 1,
		image: catalogPhoto2,
